...
public final class YouDaoTranslate {
    ...
    public String translateToCHS(String text)  {
    ...
    public String translateToCHT(String text)  {
     ...
     * @return 翻译结果
     */
    public String translate(String text, String from, String to, String apiUrlYouDao, String apiKeyYouDao, String apiSecretYouDao, String apiVocabIdYouDao) {
        /*
        ...
        return getTranslation(responseJson);
    }

    private String getTranslation(String responseJson){
        JSONArray translation;
        try {
            JSONObject jsonObject = JSON.parseObject(responseJson);
            if (jsonObject.getIntValue("errorCode") != 0) {
                return "--------接口异常，错误码：" + jsonObject.getString("errorCode");
            }
            translation = jsonObject.getJSONArray("translation");
        } catch (Exception e) {
            return "--------接口异常：" + responseJson;
        }
